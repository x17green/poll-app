      ...
      <div className="container-responsive relative z-10">
        ...
        <div className={cn('mb-8', isMobile ? 'mb-6' : '')}>
          ...
          >
            ...
            <Link
              href="/polls/new"
              className={cn(isMobile ? 'w-full' : 'w-full sm:w-auto')}
            >
              <Button
                variant="gradient"
          ...
          {showFilters && (
            <Card
              variant="glass"
              className="mb-6 animate-slide-down border-border/50 hover:shadow-glow-sm transition-all duration-300"
            >
        ...
        {filteredPolls.length > 0 ? (
          ...
          <Card
            variant="glass"
            className="border-border/50 hover:shadow-glow-sm transition-all duration-300"
          >
            <CardContent
              className={cn(
