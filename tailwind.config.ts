    ...
    extend: {
      ...
      keyframes: {
        ...
        pulseGlow: {
          ...
          '50%': {
            opacity: '1',
            boxShadow: '0 0 40px hsl(var(--brand-blue) / 0.6)'
          },
        },
        gradientX: {
      ...
      boxShadow: {
        ...
        'glow-sm': '0 0 10px hsl(var(--brand-blue) / 0.3)',
        'glow': '0 0 20px hsl(var(--brand-blue) / 0.4)',
        'glow-lg': '0 0 40px hsl(var(--brand-blue) / 0.5)',
        'glass': '0 8px 32px rgb(31 38 135 / 37%)',
        'glass-hover': '0 20px 40px rgb(31 38 135 / 50%)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'gradient-brand': 'linear-gradient(135deg, hsl(var(--brand-blue)), hsl(var(--brand-blue-light)))',
        'gradient-premium': 'linear-gradient(135deg, hsl(var(--brand-blue)) 0%, hsl(var(--brand-blue-light)) 50%, hsl(var(--brand-blue-dark)) 100%)',
      ...
      typography: {
        DEFAULT: {
          css: {
            ...
            '--tw-prose-links': 'hsl(var(--brand-blue))',
